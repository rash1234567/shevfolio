    ...
    <section id='portfolio'>
      ...
      <div className='container portfolio__container'>
        <article className='portfolio__item'>
          ...
          <img src='https://photos.app.goo.gl/Y8qNyAdXeY5jd7gZ6' </div>
          <h3>Vividioz</h3>
        ...
        <article className='portfolio__item'>
          <div className='portfolio__item-image'>
          <img src='https://photos.app.goo.gl/7EYScmhHrkJHnCxSA' alt="" />
          </div>
          <h3>A'pple</h3>
          <div className='portfolio__item-cta flex justify-around'>
        ...
        <article className='portfolio__item'>
          <div className='portfolio__item-image'>
          <img src='https://photos.app.goo.gl/pqpmRxcCsRm8j8JN6' alt="" />
          </div>
